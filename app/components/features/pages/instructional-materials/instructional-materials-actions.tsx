...
interface IInstructionalMaterialsActionsProps {
  id: number;
}

const InstructionalMaterialsActions: React.FC<IInstructionalMaterialsActionsProps> = ({ id }) => {
...
export default InstructionalMaterialsActions;
