...
const SIDEBAR_WIDTH = "200px"; // "24rem"
const SIDEBAR_WIDTH_MOBILE = "150px"; // "18rem"
const SIDEBAR_WIDTH_ICON = "25px"; // "3rem"
    ...
    >
      ...
      <div
        className={cn(
          ...
          `fixed inset-y-0 z-10 hidden h-svh w-[${SIDEBAR_WIDTH}] transition-[left,right,width] duration-200 ease-linear md:flex`,
          side === "left"
