...
export const StreamsLessonsTable: FC<IStreamLessonsTableProps> = ({
  ...
  return (
    <>
      {!lessons.length ? (
        <div className="font-mono py-20 text-center">
          Потік не вибрано. Натисніть на кнопку "Список потоків" та виберіть
          <br /> потік для перегляду навчального навантеження об`єднаних в потік груп
        </div>
      ) : (
